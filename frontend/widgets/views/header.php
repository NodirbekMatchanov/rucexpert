...
?>
<header id="header" class="header-transparent header-semi-transparent"
                            ...
                            <nav class="header-nav-top">
                                <ul class="nav nav-pills" style="align-items: center">
                                    <li class="nav-item nav-item-borders py-2">
                                        <a href="/news"><i class="far fa-newspaper text-4 text-color-primary"
                                ...
                                <nav class="collapse">
                                    <ul class="nav nav-pills" id="mainNav">
                                        ...
                                        <li class="dropdown dropdown-mega">
                                            <a class="dropdown-item dropdown-toggle" href="#o-proekte">
                                                О проекте
                                                <i class="fas fa-chevron-down"></i></a>
                                        </li>
                                    </ul>
