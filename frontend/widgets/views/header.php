        ...
        <div class="header-body border-top-0 ">
            ...
            <div class="header-container container z-index-2" style="min-height: 122px;">
                <div class="header-row">
                    ...
                    <div class="header-column mobil-login" style="display: none">
                        <div class="header-row">
                            <div class="header-nav-features header-nav-features-no-border header-nav-features-lg-show-border order-1 order-lg-2 ">
                                <div class="header-nav-feature header-nav-features-user d-inline-flex  signin"
                                     id="headerAccount">
                                    <?php if (Yii::$app->user->isGuest): ?>
                    ...
                    <div class="header-column justify-content-end">
                        <div class="header-row">
                            <div class="header-nav header-nav-links header-nav-dropdowns-dark header-nav-light-text order-2 order-lg-1"
                                ...
                                <button class="btn header-btn-collapse-nav pull-right" data-toggle="collapse"
                    ...
                    <div class="header-column justify-content-end">
                        <div class="header-row">
                            <nav class="header-nav-top">
                                <ul class="nav nav-pills" style="align-items: center">
                                    <li class="nav-item nav-item-borders py-2">
                                        <a href="<?= Url::to(['/news']) ?>"><i
                                                    class="far fa-newspaper text-4 text-color-primary"
