...
class LoginAppAsset extends AssetBundle
{
    ...
    public $css = [
        ...
        'css/default.css',
        'css/theme.css',
        'new_temp/admin/vendor/bootstrap-fileupload/bootstrap-fileupload.min.css',
    ];
    public $js = [
//        'new_temp/news/vendor/jquery/jquery.min.js',
        ...
        'new_temp/admin/vendor/bootstrap-wizard/jquery.bootstrap.wizard.js',
        'new_temp/admin/vendor/bootstrap-fileupload/bootstrap-fileupload.min.js',
