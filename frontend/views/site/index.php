...
<div role="main" class="main">
    ...
    <div class="container">
        ...
        <div id="o-proekte"class="row text-center pt-3">
            <div class="col-md-10 mx-md-auto">
                ...
                <h3 style="color: green;font-weight: bold;"><center>База реестра: <?= $count ?></center></h3>
                ...
                <p class="lead appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300" style="animation-delay: 300ms;">
                    Въехать в отель, снять апартаменты, одолжить машину в каршеринге сейчас проще простого: достаточно скачать приложение и иметь под рукой кредитку. Недобросовестные граждане пользуются этой доступностью, нанося вред имуществу и репутации компании. <br>Решение проблемы – прямо перед вами: <br><b>RUC EXPERT</b> – реестр безответственных постояльцев и арендаторов.
                </p>
            </div>
        </div>
    ...
    <div class="container container-lg py-5 my-2">
        <div class="row text-center text-md-left">
            <div class="col-lg-4 mt-5 appear-animation animated fadeInLeftShorter appear-animation-visible" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="600" style="animation-delay: 600ms;">
                <p class="text-7 gradient-text-color font-weight-bold line-height-5 negative-ls-2">RUC.EXPERT - Онлайн сервис, который всегда доступен 24 / 7 / 365 на любом усройстве.</p>
            </div>
            <div class="col-lg-8">
                <div class="row featured-boxes featured-boxes-style-4">
                    <div class="col-md-6">
                        <div class="featured-box featured-box-primary featured-box-effect-4 appear-animation animated fadeInLeftShorter appear-animation-visible" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="400" style="height: 191px; animation-delay: 400ms;">
                    ...
                    <div class="col-md-6">
                        <div class="featured-box featured-box-primary featured-box-effect-4 appear-animation animated fadeInLeftShorter appear-animation-visible" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="200" style="height: 191px; animation-delay: 200ms;">
                            <div class="box-content px-4">
                                ...
                                <p class="px-3 mb-0">Сайт RUC.EXPERT постоянно доступен в любой момент, когда Вам понадобится.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-3 col-lg-3">
                    <div class="call-to-action-btn">
                        <a href="#" data-toggle="modal" data-target="#signModal" class="btn btn-modern text-2 btn-light">ЗАРЕГИСТРИРОВАТЬСЯ</a><span class="arrow hlb d-none d-md-block appear-animation animated rotateInUpLeft appear-animation-visible" data-appear-animation="rotateInUpLeft" style="left: 110%; top: -40px; animation-delay: 100ms;"></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container container-lg">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 col-lg-7 col-xl-6 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="200">
                    RUC.EXPERT – международная база. Постоялец, грубо нарушивший правила в отеле в Белоруссии, получит отказ в заселении в России. В Австрии. В Греции. Где угодно. Безнаказанность – в прошлом.
