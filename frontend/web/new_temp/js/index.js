    ...
    CitiesSlider.prototype.render = function render() {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                'Международный реестр нарушителей.'
            ),
            React.createElement(
                'div',
                    ...
                    return React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    'button',
                                    { className: 'slider__slide-readmore btn btn-blue','data-toggle':"modal" ,'data-target':"#largesizemodal" },
                                    'Регистрация'
                                ),
                                React.createElement(
                                    'a',
                                    { className: 'slider__slide-readmore btn btn-blue inline' , },
                                    'Авторизация'
                                )
                            ),
            ...
            React.createElement('div', {
                className: 'slider__control', onClick: function onClick() {
                    return _this4.changeSlides(-1);
                }
            }),
            React.createElement('div', {
                className: 'slider__control slider__control--right', onClick: function onClick() {
                    return _this4.changeSlides(1);
                }
            }),
...
var slides = [
    {
        city: '',
        country: ' RUC EXPERT – доступный в освоении инструмент для владельца отельного бизнеса, службы\n' +
            '                                каршеринга,\n' +
            '                                арендодателя. Реестр решает сразу две задачи – наказать недобросовестных арендаторов и\n' +
            '                                оградиться от\n' +
            '                                них\n' +
            '                                в дальнейшем. Работа нашей базы в перспективе усилит ответственность гостей, исключит\n' +
            '                                нежелательных\n' +
            '                                клиентов и упростит жизнь законопослушным гражданам и бизнесу.\n' +
            '               ',
        img: 'new_temp/images/background.jpg'
    }];
